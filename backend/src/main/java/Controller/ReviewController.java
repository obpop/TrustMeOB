...
public class ReviewController {
    ...
    //private static final String API_KEY_GOOGLE = System.getenv("API_GOOGLE_KEY");
    //private static final String API_KEY_AI = System.getenv("API_OPENAI_KEY");

    private static final String API_KEY_GOOGLE = "AIzaSyDM_eCDztfCtz3tEb1XdJF_vwQXavvFYEc";
    private static final String API_KEY_AI = "sk-proj-JHHmi175cYdbGxxPgrSOT3BlbkFJYLMkBRIceyUXnh48waRh";
    ...
    public static void getReviewForPlace(Context ctx) throws IOException, InterruptedException {
        ...
        if (response.statusCode() == 200) {
            ...
            openAI.addProperty("opportunities", AIReview.get(2));
            openAI.addProperty("threats", AIReview.get(3));
    ...
    public static ArrayList<String> getAIReviews(ArrayList<String> reviews) {
        ...
        String promptOne = "Write 5 strengths from the reviews as part of a SWOT analysis. Present them as plain bullet points with no numbers, each point on a new line.";
        String promptTwo = "Write 5 weaknesses from the reviews as part of a SWOT analysis. Present them as plain bullet points with no numbers, each point on a new line.";
        String promptThree = "Write 5 opportunities for improvement from the reviews as part of a SWOT analysis. Present them as plain bullet points with no numbers, each point on a new line.";
        String promptFour = "Write 5 threats to be aware of from the reviews as part of a SWOT analysis. Present them as plain bullet points with no numbers, each point on a new line.";
        ...
        AIReviews.add(chatGPT(promptFour + reviewString));
