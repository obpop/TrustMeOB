...
public class FoursquareAPI {
    ...
    //private static final String API_KEY = System.getenv("API_FOURSQUARE_KEY");
    private static final String API_KEY ="fsq3/NPFDT5S4e6drwYEvNmLdlK3P3yi+oA4O+UTYqYBAAI=";
